...
const columns: ColumnDef<{
...
}>[] = [
  {
    ...
    header: "Date",
    cell: (info) =>
      info.getValue() ? new Date(info.getValue() as string).toDateString() : "",
  },
  ...
  },
  {
    ...
    header: "Description",
    cell: (info) => info.row.original.records[0].description,
  },
];
...
export default function SalesReport() {
  ...
  const [selectedBranch, setSelectedBranch] = useState<string>(
    activeUser?.employee ? activeUser.employee.branch_id.toString() : "",
  );
