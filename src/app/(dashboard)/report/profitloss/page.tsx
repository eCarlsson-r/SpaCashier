...
export default function ProfitLoss() {
  ...
  const [selectedRStartDate, setSelectedRStartDate] = useState<Date>(
    new Date(),
  );
  ...
  const calculateRetainedEarning = () => {
    api
      ...
      .then((response) => {
        setRetainedEarning(
          new Intl.NumberFormat("id-ID").format(response.data[0].earning),
        );
      })
      .catch((error) => {
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="grid grid-cols-5 gap-2">
            ...
            <Button
              ...
              onClick={calculateRetainedEarning}
            >
              Calculate
            </Button>
