...
export function IncomeForm({ incomeId }: { incomeId?: string }) {
    const { data: incomeData, isLoading } = useQuery({
        ...
        enabled: !!incomeId // Only fetch if we are editing
    });
        ...
        <FormProvider {...methods}>
            <form className="space-y-8" onSubmit={handleSubmit((data) => console.log(data))}>
                ...
                <div className="border rounded-lg p-4">
                    <h3 className="text-lg font-medium mb-4">Income Items</h3>
                    <Table>
                        <TableHeader>
                            <TableRow>
                ...
                {/* 3. PAYMENTS TABLE */}
                <div className="border rounded-lg p-4">
                    <h3 className="font-medium mb-4">Income Payments</h3>
                    <Table>
                        <TableHeader>
                            <TableRow>
                                <TableHead className="w-40">Type</TableHead>
                ...
                <Button className="bg-sky-600 hover:bg-sky-700" type="submit">Save Income</Button>
            </form>
        </FormProvider>
    );
}